                                ...
                                <div className="flex justify-between items-end">
                                    ...
                                    <div className="relative">
                                        ...
                                        <label
                                            ...
                                            className={`flex items-center gap-2 px-3 py-1.5 rounded-lg border text-xs font-bold transition-all cursor-pointer ${prescriptionFile
                                                ...
                                                .map(test => {
                                                    ...
                                                    return (
                                                        <button
                                                            ...
                                                            className={`p-3 rounded-xl border-2 text-sm text-left transition-all ${selectedTest === test
                                    ...
                                    {dates.map(d => {
                                        ...
                                        return (
                                            <button
                                                ...
                                                className={`flex-shrink-0 w-14 h-18 rounded-2xl border-2 flex flex-col items-center justify-center py-3 gap-0.5 transition-all ${isSelected
                                    ...
                                    <div className="grid grid-cols-4 gap-2">
                                        {slots.map(slot => (
                                            <button
                                                ...
                                                className={`py-2 px-1 rounded-xl border-2 text-xs font-bold transition-all ${selectedSlot === slot
                ...
                <div className="flex items-center gap-2 p-1 bg-slate-100 rounded-2xl">
                    {categories.map(cat => (
                        <button
                            ...
                            className={`px-5 py-2 rounded-xl text-sm font-bold transition-all whitespace-nowrap ${activeCategory === cat ? 'bg-white text-emerald-600 shadow-sm' : 'text-slate-500 hover:text-slate-700'
                                }`}
                        >
                            {cat}
                        </button>
